...
pub(super) fn start_distributed_cycle<C: LlmClient>(
    ...
    let (distributed_checkpoint_config, controller_store) = {
        ...
        (
            DistributedCheckpointConfig {
                ...
                required_extension_namespaces: checkpoint_config
    ...
    let started = backend.start_with_controller_store(
        task.clone(),
        distributed_checkpoint_config,
        budget_limits,
        controller_store,
    );
    controller
