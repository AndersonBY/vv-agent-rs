...
use super::anthropic_prompt_cache::apply_claude_prompt_cache;
...
fn request_metadata_for_prompt_cache(request: &LlmRequest) -> Value {
...
fn apply_prompt_cache_to_chat_request(
    endpoint_type: &str,
    model: &str,
    metadata: &Value,
...
fn endpoint_type_for_prompt_cache(backend: &str, provider_name: &str) -> String {
