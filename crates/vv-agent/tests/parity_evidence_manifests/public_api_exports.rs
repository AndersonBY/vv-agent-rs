fn public_export_path(id: &str) -> &'static str {
    ...
    match id {
        ...
        "agent.sub_agent_config" => {
            export_type!(vv_agent::SubAgentConfig, "vv_agent::SubAgentConfig")
        }
        ...
        "tools.metadata" => export_type!(vv_agent::ToolMetadata, "vv_agent::ToolMetadata"),
        "tools.side_effect" => {
        ...
        "events.tool_call_planned" => {
            let variant = vv_agent::RunEventPayload::ToolCallPlanned {
