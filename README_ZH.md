...
- `runtime/` 已拆成 cancellation、hooks、shell resolution、state stores、主循环、工具结果解析和 sub-agent 执行模块，让后续继续补齐 Python parity 时改动更集中。
