...
| `checkpoint-resume.md` | Checkpoint v7 ownership, model-call ledgers, deferred-tool barriers, exact resume, worker reconstruction, terminal ordering, and Apalis result transport. |
