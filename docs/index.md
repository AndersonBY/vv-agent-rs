...
| `checkpoint-resume.md` | Checkpoint v10 ownership, model-call ledgers, deferred and host-interaction barriers, controller commands, exact recovery, worker reconstruction, terminal ordering, and Apalis result transport. |
